...
const Experience = ({ viewMode }: ExperienceProps) => {
  return (
    <section id="experience" className="retro-section experience-zone py-16 md:py-20">
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-7xl">
          <h2 className="retro-heading text-center text-4xl text-violet-300 md:text-5xl">EXPERIENCE</h2>
